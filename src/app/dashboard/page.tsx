  ...
  const renderDashboard = () => (
    <div className="p-6">
      ...
      {selectedSession && <div className="border-t pt-6 mt-6">
        ...
        {selectedSession.videoPath && <div className="mb-4"><h4 className="font-semibold mb-2">Video Recording</h4><video controls className="w-full rounded-lg" src={selectedSession.videoPath.replace('/media/', '/api/media/')}>Your browser does not support video.</video></div>}
